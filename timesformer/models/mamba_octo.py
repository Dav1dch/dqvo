...
from timesformer.models.spiral_form import (
    generate_spiral_index_tensor,
    generate_optimized_octagon_spiral,
)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.spiral_indice = torch.tensor(
            # generate_spiral_index_tensor(
            #     image_height // patch_size, image_width // patch_size, re
            # )
            generate_optimized_octagon_spiral(
                image_height // patch_size, image_width // patch_size, True
            )
        ).cuda()

        length = (image_height // patch_size) * (image_width // patch_size)
        length = len(self.spiral_indice)
        # spiral_weight = (
        ...
        self.patch_embed = PatchEmbedMamba(
            ...
            indice=generate_optimized_octagon_spiral(
                image_height // patch_size, image_width // patch_size, True
            ),
        )
