...
from timesformer.models.params import par
...
class DeepVO(nn.Module):
    def __init__(self, imsize1, imsize2, batchNorm=True):
        ...
        self.clip = par.clip
        self.conv1 = conv(
            self.batchNorm, 6, 64, kernel_size=7, stride=2, dropout=par.conv_dropout[0]
        )
        self.conv2 = conv(
            self.batchNorm,
            64,
