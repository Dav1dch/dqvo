...
def build_model(args, model_params):
    ...
    if args["checkpoint"] is not None:
        checkpoint = torch.load(
            ...
            weights_only=True,
            # os.path.join("checkpoints/Exp41-copy", args["checkpoint"]), weights_only=True
        )
        if args["checkpoint"] != "base.pth":
        ...
        #     # 解冻patch_embed中的weight_proj参数
        #     for name, param in model.named_parameters():
        #         if "patch_embed.weight_proj" in name or "head" in name:
